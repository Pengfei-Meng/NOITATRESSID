...
\begin{figure}[tbp]
  \centering
   ...
   \includegraphics[clip,width=0.52\textwidth]{./figs/chap6_fstopo/1.eps} } 
   \subfloat[small \label{fig:fs3}]{
   \includegraphics[clip,width=0.52\textwidth]{./figs/chap6_fstopo/3.eps} } \\
  \subfloat[medium \label{fig:25}]{
   \includegraphics[clip,width=0.52\textwidth]{./figs/chap6_fstopo/25.eps} }
    \subfloat[medium \label{fig:27}]{
   \includegraphics[clip,width=0.52\textwidth]{./figs/chap6_fstopo/27.eps} }\\
    \subfloat[large \label{fig:29}]{
   \includegraphics[clip,width=0.52\textwidth]{./figs/chap6_fstopo/29.eps} }
    \subfloat[large \label{fig:32}]{
   \includegraphics[clip,width=0.52\textwidth]{./figs/chap6_fstopo/32.eps} }
