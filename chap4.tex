...
\begin{figure}[tbp]
  \centering
   \subfloat[Algorithm~\ref{alg:pc} with Preconditioner \label{fig:thick}]{
   \includegraphics[clip,width=0.85\textwidth]{./figs/chap6_fstopo/medium_thickness_color.pdf} }
  \hspace{1em}
  \subfloat[Algorithm~\ref{alg:pc} without Preconditioner \label{fig:thick_eye}]{
   \includegraphics[clip,width=0.85\textwidth]{./figs/chap6_fstopo/medium_eye_thickness_color.pdf} }
  \hspace{1em}
    \subfloat[SNOPT \label{fig:thick_snopt}]{
   \includegraphics[clip,width=0.85\textwidth]{./figs/chap6_fstopo/medium_thickness_snopt2.pdf} }
